...
/* HXZL2 板（GD32F470ZE）无 25MHz 外部晶振，与裸机工程一致
 * 使用内部 IRC16M 作为 PLL 时钟源（裸机 __SYSTEM_CLOCK_240M_PLL_IRC16M）
 */

#define GD32_BOARD_SYSCLK_PLL_IRC16M
...
/* Main PLL Configuration.
 *
 * PLL source is IRC16M (HXZL2 board has no 25MHz crystal,
 * same as the bare-metal __SYSTEM_CLOCK_240M_PLL_IRC16M)
 * PLL_VCO = (16,000,000 / 16) * 480
 *         = 480,000,000
 * SYSCLK  = PLL_VCO / PLLP
...
#define GD32_PLL_PLLPSC            RCU_PLL_PLLPSC(16)
...
/* Default: 240 MHz (PLL source is IRC16M: 16MHz/16*480/2 = 240MHz,
 * same as the bare-metal __SYSTEM_CLOCK_240M_PLL_IRC16M)
 */
...
/* UART3: RX=PC11, TX=PC10 (voice module) */
...
/* SPI0 OLED: MISO=PB4 (unused, placeholder), MOSI=PA7, SCK=PA5, CS=PA4 */

#define GPIO_SPI0_CSPIN     (GPIO_CFG_PORT_A | GPIO_PIN4_OUTPUT)

#define GPIO_SPI0_MISO_PIN  ((GPIO_SPI0_MISO_2 & ~GPIO_CFG_SPEED_MASK) | GPIO_CFG_SPEED_25MHZ)
