...
#define GPIO_OUT2         (GPIO_CFG_MODE_OUTPUT | GPIO_CFG_OUTPUT_SET | GPIO_CFG_SPEED_50MHZ | \
                           GPIO_CFG_PORT_A | GPIO_CFG_PIN_6)  /* OLED DC */
#define GPIO_OUT3         (GPIO_CFG_MODE_OUTPUT | GPIO_CFG_OUTPUT_SET | GPIO_CFG_SPEED_50MHZ | \
                           GPIO_CFG_PORT_A | GPIO_CFG_PIN_1)  /* OLED RES */
#define GPIO_OUT4         (GPIO_CFG_MODE_OUTPUT | GPIO_CFG_OUTPUT_SET | GPIO_CFG_SPEED_50MHZ | \
                           GPIO_CFG_PORT_A | GPIO_CFG_PIN_8)  /* LED */
#define GPIO_OUT5         (GPIO_CFG_MODE_OUTPUT | GPIO_CFG_OUTPUT_SET | GPIO_CFG_SPEED_50MHZ | \
                           GPIO_CFG_PORT_D | GPIO_CFG_PIN_4)  /* FAN */
